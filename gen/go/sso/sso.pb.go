...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // user email to register
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // user password to register
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x13, 0x62, 0x6c, 0x78, 0x73, 0x79, 0x79, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
